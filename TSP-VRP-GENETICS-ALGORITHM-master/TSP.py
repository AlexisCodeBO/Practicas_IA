...
# Clase para representar problemas a resolver mediante una
# algoritmo genético. Incluye los siguientes atributos:
# - genes: lista de posibles genes en un cromosoma
# - persons_length: longitud de cada cromosoma
# - decodificar: método que recibe el genotipo (cromosoma) como entrada y devuelve
# el fenotipo (solución al problema original representado por el cromosoma)
# - fitness: método que devuelve la evaluación de un cromosoma (actúa sobre el
# genotipo)
# - mutación: función que implementa una mutación sobre un cromosoma
# - crossover: función que implementa el operador crossover sobre dos cromosomasmutation
#=====================================================================================================================================
...
# Aquí definimos las funciones de requisitos que necesita el GA para funcionar
# La función recibe como entrada:
# * problem_genetic: una instancia de la clase Problem_Genetic, con
# el problema de optimización que queremos resolver.
# * k: número de participantes en los torneos de selección.
# * opt: max o min, indicando si es una maximización o una
# problema de minimización.
# * ngen: número de generaciones (condición de parada)
# * tamaño: número de individuos para cada generación
